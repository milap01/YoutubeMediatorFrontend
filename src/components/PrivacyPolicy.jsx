...
function PrivacyPolicy() {
    return (
        <div className='text-white m-4 pl-4'>
            <h1 className='text-6xl text-bold'>Privacy Policy</h1>
            <p className='mt-4'>Last updated: March 20, 2024</p>
            ...
            <h2 className=' text-3xl text-bold mt-4'>Interpretation and Definitions</h2>
            <h3 className=' text-xl mt-2 text-bold' >Interpretation</h3>
            ...
            <ul className='mt-2 list-disc pl-10'>
                ...
                <li className='mt-1'>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to YoutubeMediator.</p>
                </li>
                <li className='mt-1'>
                ...
                <li className='mt-1'>
                    <p><strong>Website</strong> refers to YoutubeMediator, accessible from <a href="https://youtubemediator.netlify.app/" rel="external nofollow noopener" target="_blank">https://youtubemediator.netlify.app/</a></p>
                </li>
                <li className='mt-1'> 
                    <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
                </li>
            </ul>
            <h2 className=' text-3xl text-bold mt-4'>Collecting and Using Your Personal Data</h2>
            <h3 className=' text-xl text-bold mt-2'>Types of Data Collected</h3>
            <h4 className='text-lg text-bold mt-2'>Personal Data</h4>
            ...
            <h4 className='text-lg text-bold mt-2'>Usage Data</h4>
            ...
            <h4 className='text-lg text-bold mt-2'>Tracking Technologies and Cookies</h4>
            ...
            <ul className='mt-2 list-disc pl-10'>
                <li className='mt-1'><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</li>
                <li className='mt-1'><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</li>
            </ul>
            <p className='mt-2'>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank">Free Privacy Policy website</a> article.</p>
            ...
            <h3 className='text-xl text-bold mt-2'>Transfer of Your Personal Data</h3>
            ...
            <h3 className='text-xl text-bold mt-2'>Delete Your Personal Data</h3>
            ...
            <h3 className='text-xl text-bold mt-2'>Disclosure of Your Personal Data</h3>
            <h4 className='text-lg text-bold mt-2'>Business Transactions</h4>
            ...
            <h4 className='text-lg text-bold mt-2'>Law enforcement</h4>
            ...
            <h2 className='text-2xl text-bold mt-2'>Children's Privacy</h2>
            ...
            <h2 className='text-2xl text-bold mt-2'>Links to Other Websites</h2>
            ...
            <h2 className='text-2xl text-bold mt-2'>Changes to this Privacy Policy</h2>
            ...
            <h2 className='text-2xl text-bold mt-2'>Contact Us</h2>
            <p className='mt-2'>If you have any questions about this Privacy Policy, You can contact us:</p>
            <ul>
                <li>By email: hellptheremilap@gmail.com</li>
            </ul>
        </div>
    )
}
